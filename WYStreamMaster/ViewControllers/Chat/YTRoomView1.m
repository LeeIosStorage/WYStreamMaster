...
@interface YTRoomView1 ()<UITableViewDelegate,UITableViewDataSource,YTChatControlDelegate,CellDelegate>
...
- (void)roomViewPrepare
{
    ...
    self.chatroomControl = [[YTChatRoomControl1 alloc] init];
